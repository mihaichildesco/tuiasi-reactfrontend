...
const schema = yup.object().shape({
    displayName: yup.string().required('Trebuie sa introduci un nume'),
    email: yup.string().email('Trebuie sa introduci un email valid').required('Trebuie sa introduci un email'),
    password: yup
        .string()
        .required('Te rugam sa introduci parola')
        .min(8, 'Parola este prea scurta - minim 8 caractere'),
    passwordConfirm: yup.string().oneOf([yup.ref('password'), null], 'Parolele trebuie sa fie indentice'),
    acceptTermsConditions: yup.boolean().oneOf([true], 'Trebuie sa accepti termeni si conditiile'),
});
